...
LINES=( "install cramfs /bin/true" "install freevfxs /bin/true" "install jffs2 /bin/true" "install hfs /bin/true" "install hfsplus /bin/true" "install udf /bin/true" )
...
# 1.1.14-16 Ensure nodev,nosuid,noexec option set on /dev/shm partition
# =====================================================================
